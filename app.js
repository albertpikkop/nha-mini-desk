...
const translations = {
  es: {
    ...
    ui: {
      ...
      "why.label": "Ejemplo real",
      "why.copy": "Antes: \"me ayudas a contestarle a un cliente molesto...\" Después: tarea, contexto, pendientes y verificación.",
...
${getShareUrl()}`
  ...
  en: {
    ...
    ui: {
      ...
      "why.label": "Real example",
      "why.copy": "Before: \"help me reply to an angry customer...\" After: task, context, pending items, and verification.",
...
${getShareUrl()}`
  ...
  hi: {
    ...
    ui: {
      ...
      "why.label": "Real example",
      "why.copy": "पहले: \"angry customer को reply करना है...\" बाद में: task, context, pending items और verification.",
      "steps.one": "काम चुनें",
...
${getShareUrl()}`
  ...
  pa: {
    ...
    ui: {
      ...
      "why.label": "Real example",
      "why.copy": "ਪਹਿਲਾਂ: \"angry customer ਨੂੰ reply ਕਰਨਾ ਹੈ...\" ਬਾਅਦ ਵਿੱਚ: task, context, pending items ਅਤੇ verification.",
      "steps.one": "ਕੰਮ ਚੁਣੋ",
