...
const translations = {
  es: {
    ...
    ui: {
      ...
      "hero.subtitle": "Convierte una idea en bruto en un brief claro para cualquier IA. Antes de pedirle algo a ChatGPT, Claude, Gemini, Codex o Cursor, ordena la tarea, el contexto, lo que falta y lo que debe verificarse.",
      ...
      "why.copy": "La mayoría no escribe prompts; escribe algo como: \"me ayudas a contestarle a este cliente...\" NHA Mini Desk convierte ese caos en tarea, contexto, expectativa, pendientes y reglas para no inventar.",
...
${getShareUrl()}`
  ...
  en: {
    ...
    ui: {
      ...
      "hero.subtitle": "Turn a rough idea into a clear brief for any AI. Before you ask ChatGPT, Claude, Gemini, Codex, or Cursor to work, organize the task, context, missing information, and verification rules.",
      "hero.tryExample": "Try in 20 seconds",
      "hero.privacy": "What you write is not saved in a database.",
      "why.label": "Why this helps",
      "why.copy": "Most people do not write prompts; they write something like: \"help me reply to this angry customer...\" NHA Mini Desk turns that mess into task, context, expectation, pending items, and rules against guessing.",
