...
const translations = {
  es: {
    ...
    ui: {
      ...
      "footer.meta": "v0.1.12 · © 2026 Albert Punj · Lanzado 7 May 2026",
    ...
    statuses: {
      ...
      ratingUnavailable: "La calificación solo se guarda en la versión publicada. Tu texto no salió de este navegador.",
      ratingFailed: "No se pudo guardar la calificación. Tu texto no salió de este navegador.",
...
${getShareUrl("es")}`
  ...
  en: {
    ...
    ui: {
      ...
      "footer.meta": "v0.1.12 · © 2026 Albert Punj · Released 7 May 2026",
      "footer.license": "MIT License",
    ...
    statuses: {
      ...
      ratingUnavailable: "Rating is only saved on the hosted version. Your prompt text stayed in this browser.",
      ratingFailed: "Could not save the rating. Your prompt text stayed in this browser.",
...
${getShareUrl("en")}`
  ...
  hi: {
    ...
    statuses: {
      ...
      ratingUnavailable: "Rating सिर्फ hosted version पर save होती है. आपका prompt text इसी browser में रहा.",
      ratingFailed: "Rating save नहीं हुई. आपका prompt text इसी browser में रहा.",
...
${getShareUrl("hi")}`
  ...
  pa: {
    ...
    statuses: {
      ...
      ratingUnavailable: "Rating ਸਿਰਫ hosted version ਤੇ save ਹੁੰਦੀ ਹੈ. ਤੁਹਾਡਾ prompt text ਇਸੇ browser ਵਿੱਚ ਰਿਹਾ.",
      ratingFailed: "Rating save ਨਹੀਂ ਹੋਈ. ਤੁਹਾਡਾ prompt text ਇਸੇ browser ਵਿੱਚ ਰਿਹਾ.",
